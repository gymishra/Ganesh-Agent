...
<body>
    <div class="container">
        ...
        <div class="demo-note">
            <strong>Demo Mode:</strong> Use any username/password to login, or click AWS SSO for simulated Identity Center login.
        </div>
...
@app.route('/sso-login')
def sso_login():
    # Direct redirect to AWS Identity Center portal
    return redirect('https://d-9767435275.awsapps.com/start#/')

@app.route('/sso-callback')
def sso_callback():
    # Handle return from SSO portal
...
<body>
    ...
    ''', user=session['user'], directories=directories, auth_badge=auth_badge, 
         bucket=S3_BUCKET, internal_ip=INTERNAL_IP)
